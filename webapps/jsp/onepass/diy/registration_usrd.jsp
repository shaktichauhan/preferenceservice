...
<title>Family Handyman</title>
<link rel="stylesheet" type="text/css" href="css/diy/style.css" />
...
<noscript>
<p>
<img src="http://b.scorecardresearch.com/p?c1=2&c2=16404798&ns_site=familyhandyman&_site=familyhandyman&name=familyhandyman%3a+diy%3a+entry+form&category=diy&content_name=diy%3a+entry+form&pv_event=true&content_type=diy&prod_view=true&ns_campaign=<%=trkid %>&campaign=<%=trkid %>" height="1" width="1" alt="*">
</p>
</noscript>
...
<div id="wrapper">
  <div id="container">
    <!--Content-->
    <div id="content"> <span class="logo"><img src="css/diy/images/logo.jpg" alt="Reader&#39;s Digest" width="291" title="Reader&#39;s Digest" /></span>
      <div class="details">
        <div class="cl"></div>
      </div>
    </div>
        ...
        <div class="wrap">
          ...
          <div class="section">
            ...
            <input type="hidden" name="promotable" id="promotable" value="20" />
             ...
             <input type="hidden" name="appId" id="appId" value="DIY" />
    ...
    <div class="cl"></div>
   <!--Footer-->
    <div id="footer"> <span class="copy">&copy; 2014 The Family Handyman, Inc. All rights reserved. </br>
    Apple, the Apple logo, iPad, and iPhone, are trademarks of Apple, Inc registered in the U.S. and other countries. App Store is a service mark of Apple, Inc. </span>  </div>
    <!--Footer End -->
  </div>
</div>
