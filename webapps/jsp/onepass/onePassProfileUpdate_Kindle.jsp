...
<%
		...
		if(sourceId == null || "".equals(sourceId.trim())) {
			sourceId = "770"; // default ipad RD source id
		}
...
<body onload="selectedCountry();">
	<html:form action="onePassKindleUpdateAction.do" styleId="onePassDigReg">
	...
	<img src="image/readers-digest-logo.gif" width="220" height="102" border="0" />
		...
		<fieldset>
			...
			<ol>
				...
				<html:hidden property="newEmailAddress" value="<%=newEmailAddress%>"></html:hidden>
