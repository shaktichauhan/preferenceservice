...
<body onload='selectedCountry();'>
	...
	<div id="onePassDigReg">
		...
		<div id="onePassDigReg">
		<fieldset>
		<input type="hidden" name="promotable_unchecked" value="146:13" id="promotable_unchecked" />
			<ol class="optbox">
			
			    <li><input type="checkbox" name="promotable" value="143" id="promotable_field" checked="checked" />Send me occasional e-mail updates and special offers from Reader's Digest.<br />
                    <input type="checkbox" name="promotable" value="13" id="promotable_field" checked="checked"/>Get special offers from third parties whom we've specially selected just for you.<br /><br />
