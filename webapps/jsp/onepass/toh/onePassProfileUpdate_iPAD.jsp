...
<body onload="selectedCountry();">
	...
	<html:form action="onePassIpadUpdateAction.do">
	<div id="outer-container">
		...
		<input type="hidden" name="promotable_unchecked" value="146:13" id="promotable_unchecked" />
			...
			<ol class="optbox">
			    ...
			    <li><input type="checkbox" name="promotable" value="146" id="promotable_field" />I’d like to receive occasional Emails with updates and special offers from Taste of Home and your Family of Publications.<br />
                    <input type="checkbox" name="promotable" value="13" id="promotable_field" />I would like to receive occasional Emails with updates and special offers from carefully screened companies whose products and services may be of interest to me.<br /><br />
