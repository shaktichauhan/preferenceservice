...
<%
		...
		if(sourceId == null || "".equals(sourceId.trim())) {
			sourceId = "852"; // default ipad TOH source id
		}
...
<input type="hidden" name="promotable_unchecked" value="146:13" id="promotable_unchecked" />
			<ol class="optbox">
			    ...
			    <li><input type="checkbox" name="promotable" value="146" id="promotable_field" checked="checked" />I’d like to receive occasional Emails with updates and special offers from Taste of Home and your Family of Publications. <br />
                    <input type="checkbox" name="promotable" value="13" id="promotable_field" checked="checked" />I would like to receive occasional Emails with updates and special offers from carefully screened companies whose products and services may be of interest to me.<br /><br />
