...
<title>Reader's Digest | One Free Issue</title>
<meta property="og:title" content="Reader's Digest | One Free Issue">
<meta property="og:description" content="Put your feet up and enjoy! For a limited time, you can download the latest issue of Reader's Digest on iPad and iPhone for FREE. Discover uplifting real-life stories, profiles of inspiring people, family-friendly humor, practical advice and more.">
...
<%
	...
	String recipiantEmailAddress= request.getParameter("recipiantEmailAddress");
 	...
 	if(trkid == null || "".equals(trkid.trim())) {
 		trkid = "brandadvocatefb";
 	}
	%>
</head>
...
udm_('http'+(document.location.href.charAt(4)=='s'?'s://sb':'://b')+'.scorecardresearch.com/b?c1=2&c2=16404798&ns_site=rdna&_site=rd&name=rd%3a+brandadvocate%3a+freegiftregistrationpage&category=brandadvocate&content_name=brandadvocate%3a+freegiftregistrationpage&pv_event=true&content_type=brandadvocate'+campaign);
--></script>
<noscript><p><img src="http://b.scorecardresearch.com/p?c1=2&c2=16404798&ns_site=rdna&_site=rd&name=rd%3a+brandadvocate%3a+freegiftregistrationpage&category=brandadvocate&content_name=brandadvocate%3a+freegiftregistrationpage&pv_event=true&content_type=brandadvocate"+campaign height="1" width="1" alt="*"></p></noscript><form method="post" action="freeGiftRegistrationAction.do" name="registrationForm" class="registration" onSubmit="return ValidateForm(document.forms[0])" >
<div id="container">
	<div id="header">
 <img src="jsp/brandAdvocate/images/logo.png" />
	...
	<div id="left">
    <h1>READ UP!</h1>
      <h2>CLAIM YOUR ONE FREE DIGITAL ISSUES OF READER'S DIGEST </h2>
   <img src="jsp/brandAdvocate/images/ipad2.png" class="ipad" />
	...
	<p>Complete the fields below to start your free 1-issue subscription. No strings! This is a gift from your friend, and gifts are always free! 
	  <br />
	<p>
   ...
   <input type="text" placeholder="First Name" name="recipiantFirstName" value='<%=(recipiantFirstName == null?"":recipiantFirstName )%>' id="recipiantFirstName"/></div>
    ...
    <div class="email">  <input type="text" placeholder="Email Address"  value='<%=(recipiantEmailAddress == null?"":recipiantEmailAddress )%>' name="recipiantEmailAddress" id="recipiantEmailAddress"/> </div>
      ...
      <div class="number"></div>
    <div class="friend">
    <div class="email">  <input type="password" placeholder="Create a Password" name="recipiantPassword" id="recipiantPassword"  />
  </div>
    </div>
   ...
   <div class="friend">
    ...
    <input type="hidden" value=<%= request.getParameter("token") %> name="token" />
     ...
     <input type="hidden" value="ADV_RDO_1" name="userType" />  
  ...
  <div class="footer">
    <p>*Free, 1-issue digital subscription available only to non-subscribers of <em>Reader&rsquo;s Digest</em> magazine.</p>
