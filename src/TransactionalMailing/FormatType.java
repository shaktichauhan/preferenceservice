...
public class FormatType implements java.io.Serializable {
    ...
    public static final FormatType File = new FormatType(_File);
    public static final FormatType Data = new FormatType(_Data);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:TransactionalMailing", "FormatType"));
    }
    /**
