...
public class AuthDetails  implements java.io.Serializable {
    ...
    /**
     * Gets the password value for this AuthDetails.
     * 
     * @return password
     */
    ...
    /**
     * Sets the password value for this AuthDetails.
     * 
     * @param password
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:TransactionalMailing", "AuthDetails"));
