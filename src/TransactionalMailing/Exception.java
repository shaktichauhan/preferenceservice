...
public class Exception  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    /**
     * Gets the text value for this Exception.
     * 
     * @return text
     */
    ...
    /**
     * Sets the text value for this Exception.
     * 
     * @param text
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:TransactionalMailing", "Exception"));
