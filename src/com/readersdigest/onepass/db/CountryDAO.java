 ...
 * datastore.
 * 
 * @see com.readersdigest.onepass.db.Country
...
public class CountryDAO implements ICountryDAO {
    ...
    public static final String DESCRIPTIVE_INFORMATION = "descriptiveInformation";
    ...
    public void delete(Country entity) {
        ...
        try {
            entity = getEntityManager().getReference(Country.class, entity.getCountryCode());
    ...
    public List<Country> findByProperty(String propertyName, final Object value) {
        EntityManagerHelper.log("finding Country instance with property: " + propertyName + ", value: " + value, Level.INFO, null);
        try {
    ...
    public List<Country> findByDescriptiveInformation(Object descriptiveInformation) {
        return findByProperty(DESCRIPTIVE_INFORMATION, descriptiveInformation);
    }
