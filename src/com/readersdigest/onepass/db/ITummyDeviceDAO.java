...
/**
 * Interface for TummyDeviceDAO.
 * 
 * @author MyEclipse Persistence Tools
 */

public interface ITummyDeviceDAO {
	/**
	 ...
	 * <pre>
	 * EntityManagerHelper.beginTransaction();
	 * entity = ITummyDeviceDAO.update(entity);
	 * EntityManagerHelper.commit();
	 * </pre>
	 * 
	 * @param entity
	 ...
	 */
	public List<TummyDevice> findByProperty(String propertyName, Object value,
	 ...
	 */
	public List<TummyDevice> findAll(int... rowStartIdxAndCount);
}