...
public interface IEmailValidationDAO {
	/**
	 ...
	 */
	public List<EmailValidation> findByProperty(String propertyName, Object value,
	 ...
	 */
	public List<EmailValidation> findAll(int... rowStartIdxAndCount);
}